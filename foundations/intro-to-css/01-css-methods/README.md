...
### Self Check
- Did you use all three methods of adding CSS to an HTML file? (N)
- Did you properly link the external CSS file in the HTML file? (N) 
- Does the `div` element have CSS added via the external method? (N)
- Does the `p` element have CSS added via the internal method? (N)
- Does the `button` element have CSS added via the inline method? (N)
